    ...
    "paths": {
        ...
        "/api/v1/events": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Show ONLY soft-deleted events",
                        "name": "only_deleted",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/events/bulk/cancel": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Event IDs to cancel",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.BulkStatusResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/events/bulk/complete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Event IDs to complete",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/events/bulk/duplicate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Events to duplicate",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/eventhandler.BulkDuplicateRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.BulkDuplicateResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/events/bulk/permanent": {
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Event IDs to permanently delete",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/events/bulk/publish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Event IDs to publish",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.BulkRestoreResult"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/eventhandler.DuplicateEventRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.Event": {
            ...
            "properties": {
                ...
                "institutionID": {
                    "description": "✅ NEW: Institution this event belongs to",
                    "type": "string"
                },
                "isActive": {
        ...
        "eventhandler.DuplicateEventRequest": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string"
        ...
        "eventhandler.EventResponse": {
            ...
            "properties": {
                ...
                "institution_id": {
                    "description": "✅ NULL for personal events",
                    "type": "string"
                },
                "is_active": {
                    "type": "boolean"
                ...
                "team_type": {
                    "description": "✅ NEW: \"personal\" or \"institution\"",
                    "type": "string"
                },
                "thumbnail_url": {
                    "type": "string"
        ...
        "service.BulkDuplicateResult": {
            "type": "object",
            "properties": {
                "createdEvents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.DuplicatedEvent"
                    }
                },
                "duplicatedCount": {
                    "type": "integer"
