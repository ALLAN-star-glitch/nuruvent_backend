// internal/modules/media/mediarepo/media_type_repository.go
...
func (r *MediaTypeRepository) GetByID(id uuid.UUID) (*models.MediaType, error) {
...
func (r *MediaTypeRepository) GetByName(name string) (*models.MediaType, error) {
	var mediaType models.MediaType
...
func (r *MediaTypeRepository) GetAll() ([]models.MediaType, error) {
...
func (r *MediaTypeRepository) GetByBucket(bucket string) (*models.MediaType, error) {
	var mediaType models.MediaType
